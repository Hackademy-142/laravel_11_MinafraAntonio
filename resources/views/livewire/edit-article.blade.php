    ...
    <div class="container my-5">
        <div class="row justify-content-center ">
            <div class="col-12 col-md-8">
                ...
                wire:submit="updateArticle" {{-- con questa sintassi vado a richiamare la funzione store al submit del bottone del form --}}
                >
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input wire:model.blur="subtitle" type="text" class="form-control" id="subtitle">{{-- .blur la validazione parte nel moemtno in cui cambio l input che sto digitando --}}
                        <div class="text-danger">@error('subtitle') {{ $message }} @enderror</div>
                    </div>
                    <div class="mb-3">
                        <label for="body" class="form-label">Corpo articolo</label>
                        <input wire:model.blur="body" type="text" class="form-control" id="body">
                        <div class="text-danger">@error('body') {{ $message }} @enderror</div>{{-- nuovo metodo di gestione degli errori per il client --}}
                    </div>
